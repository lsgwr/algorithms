...
![递归调用和普通嵌套调用的联系和区别](https://img1.sycdn.imooc.com/szimg/5def64ba000132a419201080.jpg)
...
+ **递归到最深层的过程**
  ...
  > ![递归到最深层的过程](https://img1.sycdn.imooc.com/szimg/5def67b200010f5619201080.jpg)
+ 接上面，演示**从最深往回递归的过程**,回退的过程中在回退前访问过的节点都不会再访问了
  ...
  > ![递归到1发现未dfs遍历的节点4](https://img.mukewang.com/szimg/5def68510001fbfc19201080.jpg)
  + 访问4，4放入order数组并设置`visited[4]=true`，挂起dfs(4)，访问4的邻接点，邻接点有(1)      ，先访问到1，因为`visited[1]=true`，此外4再无邻接点，所以4的邻接点都访问完了
  > ![在dfs(1)基础上往下递归调用dfs(4)](https://img1.sycdn.imooc.com/szimg/5def68c80001e2fc19201080.jpg)
  ...
  > ![递归回到起始点0](https://img.mukewang.com/szimg/5def690c0001f3de19201080.jpg)
