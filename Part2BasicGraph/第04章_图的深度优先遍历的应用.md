...
![DFS遍历到target就提前退出](images/第4章_图的深度优先遍历的应用/DFS遍历到target就提前退出.png)
...
![无向图环检测例子1](images/第4章_图的深度优先遍历的应用/无向图环检测例子1.png)


### 无向图环检测例子2
> 下面的图当遍历到点4时，可以发现点1已经被访问，但是点1并不是2的上一个访问节点(3才是)，所以该图时存在环地

![无向图环检测例子2](images/第4章_图的深度优先遍历的应用/无向图环检测例子2.png)
...
![两个等效的图](images/第4章_图的深度优先遍历的应用/两个等效的图.png)
