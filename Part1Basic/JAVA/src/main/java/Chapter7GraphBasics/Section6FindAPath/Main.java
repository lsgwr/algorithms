...
public class Main {
    public static void main(String[] args) {
        ...
        String filename1 = "/Users/liangshanguang/Program/Algorithm/liuyubobobo-algorithms/Part1Basic/JAVA/src/main/java/Chapter7GraphBasics/Section6FindAPath/graph1.txt";
