...
public class Main {
    public static void main(String[] args) {
        ...
        String filename1 = "src/main/java/Chapter7GraphBasics/Section5DFSAndConnectedConponents/graph1.txt";
        ...
        String filename2 = "src/main/java/Chapter7GraphBasics/Section5DFSAndConnectedConponents/graph2.txt";
