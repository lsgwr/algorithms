...
public class Main {
    public static void main(String[] args) {
        ...
        String filename1 = "/Users/liangshanguang/Program/Algorithm/liuyubobobo-algorithms/Part1Basic/JAVA/src/main/java/Chapter7GraphBasics/Section7BFSShortestPath/graph1.txt";
        SparseGraph g1 = new SparseGraph(13, false);
        ReadGraph readGraph1 = new ReadGraph(g1, filename1);
        g1.show();
        System.out.println();
        Path path1 = new Path(g1, 0);
        System.out.print("DFS path of 0 to 3 :");
        path1.showPath(3);
        ...
        String filename2 = "/Users/liangshanguang/Program/Algorithm/liuyubobobo-algorithms/Part1Basic/JAVA/src/main/java/Chapter7GraphBasics/Section7BFSShortestPath/graph2.txt";
