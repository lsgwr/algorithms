...
public class Main {
    public static void main(String[] args) {
        ...
        String filename1 = "src/main/java/Chapter7GraphBasics/Section7BFSShortestPath/graph1.txt";
        ...
        String filename2 = "src/main/java/Chapter7GraphBasics/Section7BFSShortestPath/graph2.txt";
