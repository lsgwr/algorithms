...
> 和图论中的连通性问题是一样的，这里应该是图论中的连通性问题的提取和抽象。参考[图论中实现地判断两个点的连通性](https://github.com/19920625lsg/liuyubobobo-algorithms/blob/master/Part2BasicGraph/第04章_图的深度优先遍历的应用.md#43-判断两个点在给定的图中是否是可连接connected地)
