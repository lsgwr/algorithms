...
![QuickUnion的思路1](https://img1.sycdn.imooc.com/szimg/5e0dccc3000146a419201080.jpg)

下面我们从5指向2进行了连接，形成了一个新的树，在这个新树上所有的节点都连接在了一起~~任意两个节点是否连通只要判断他们的根节点是否相同即可
![QuickUnion的思路2](https://img.mukewang.com/szimg/5e0dcd600001237319201080.jpg)
...
+ `union(6, 2)`:6有父节点，通过parent不断向上找，得到`6所在联通分量的根节点pRoot`为0；2有父节点，通过parent不断向上找，得到`2所在联通分量的根节点qRoot`为1。所以把`pRoot=0`指向`qRoot=1`，即`parent[pRoot]=qRoot`，即设置`parent[0]=1`
  > ![union6_2](https://img1.sycdn.imooc.com/szimg/5e0dd9d00001df6a19201080.jpg)
+ 到此为止我们的构造的并查集如下
  > ![到此为止我们的构造的并查集如下](https://img1.sycdn.imooc.com/szimg/5e0ddabf00014d0619201080.jpg)
