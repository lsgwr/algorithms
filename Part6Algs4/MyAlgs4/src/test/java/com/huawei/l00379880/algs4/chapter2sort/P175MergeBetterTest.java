...
* @description  
*/ 
public class P175MergeBetterTest {
    @Test
    ...
    public void testComparator() {
        ...
        P175MergeBetter.sort(a, new DogComparatorByName());
        System.out.println(Arrays.toString(a));
    }
    ...
    public void testMain() {
        ...
        P175MergeBetter.sort(a, 0, 2);
        System.out.println(Arrays.toString(a));
        System.out.println("排后3个:");
        P175MergeBetter.sort(a, a.length - 3, a.length - 1);
        System.out.println(Arrays.toString(a));
