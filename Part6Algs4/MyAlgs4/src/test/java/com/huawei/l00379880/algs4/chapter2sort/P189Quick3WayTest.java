...
* @description  
*/ 
public class P189Quick3WayTest {
    @Test
    public void testComparator() {
        ...
        P187QuickBetter.sort(a, new DogComparatorByAge());
        System.out.println(Arrays.toString(a));
        System.out.println("*****************按照名称排序后****************");
        P187QuickBetter.sort(a, new DogComparatorByName());
        System.out.println(Arrays.toString(a));
    }
    ...
    public void testMain() {
        ...
        P189Quick3Way.sort(a, 0, 4);
        System.out.println(Arrays.toString(a));
        System.out.println("排后5个:");
        P189Quick3Way.sort(a, a.length - 5, a.length - 1);
        System.out.println("排后结果:");
        System.out.println(Arrays.toString(a));
        System.out.println("升序:");
        P189Quick3Way.sort(a);
        System.out.println(Arrays.toString(a));
