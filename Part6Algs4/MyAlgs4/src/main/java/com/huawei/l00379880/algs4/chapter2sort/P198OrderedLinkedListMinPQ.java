...
/********************************************************************
 * @Description : 链表实现的最小有序优先队列,体现在每次push的时候都保证有序.
 *                Key 可比较的泛型数据类型
 * @author      : 梁山广
 * @date        : 2018/1/3 11:02
 * @email       : liangshanguang2@gmail.com
 *****************************************************************/
public class P198OrderedLinkedListMinPQ<Key extends Comparable<Key>> {
    /**
     * 栈顶节点
     */
    ...
    public P198OrderedLinkedListMinPQ(int capacity) {
        // 成员初始化
        this.first = null;
        this.n = 0;
    }
    ...
    public void insert(Key key) {
        ...
        // 控制是否需要对插入节点进行移动的标志位
        boolean flag = false;
        // 寻找插入点.当链表找到头,或者找到第一个元素比之大的节点是,退出while循环
        while (current.next != null && P153CommenFuns.more(first.item, current.next.item)) {
            flag = true;
