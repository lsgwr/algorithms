/***********************************************************
 * @Description : 基于符号表的有向图
 * @author      : 梁山广(Laing Shan Guang)
 * @date        : 2018/2/20 下午5:15
...
public class P376SymbolDigraph {
    /**
     * 键：符号字符串, 值：原来图中的整数索引
     * string -> index
     */
     ...
     */
    public P376SymbolDigraph(String filePath, String delimiter) {
        st = new P230ST<>();
        ...
        // line to all others
        // 初始化指定节点数的图
        digraph = new P366Digraph(st.size());
        // 前面读完了，这里得再读一次
        in = new In(filePath);
