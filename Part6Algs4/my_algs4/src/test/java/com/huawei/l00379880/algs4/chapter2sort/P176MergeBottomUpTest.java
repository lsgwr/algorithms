...
* @description  
*/ 
public class P176MergeBottomUpTest {
    @Test
    ...
    public void testComparator() {
        ...
        P175MergeBetter.sort(a, new DogComparatorByAge());
        System.out.println(Arrays.toString(a));
        System.out.println("*****************按照名称排序后****************");
        P176MergeBottomUp.sort(a, new DogComparatorByName());
        System.out.println(Arrays.toString(a));
    }
    ...
    public void testMain() {
        ...
        P176MergeBottomUp.sort(a, 0, 2);
        System.out.println(Arrays.toString(a));
        System.out.println("排后3个:");
        P176MergeBottomUp.sort(a, a.length - 3, a.length - 1);
        System.out.println(Arrays.toString(a));
