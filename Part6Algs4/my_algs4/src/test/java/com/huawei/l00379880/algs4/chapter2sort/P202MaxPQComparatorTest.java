 ...
 * @description
 */
public class P202MaxPQComparatorTest {
    /**
     * Description:
     */
    @Test
    public void testMain() {
        ...
        P202MaxPQComparator<Dog> maxPQ1 = new P202MaxPQComparator<>(new DogComparatorByAge(), a);
        for (Dog dog : maxPQ1) {
            System.out.println(dog);
        }
        System.out.println("*****************按照名称排序后****************");
        P202MaxPQComparator<Dog> maxPQ2 = new P202MaxPQComparator<>(new DogComparatorByName(), a);
        for (Dog dog : maxPQ2) {
            System.out.println(dog);
        }
    }
