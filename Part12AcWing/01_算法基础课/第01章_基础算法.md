...
## 六、位运算
> LeetCode上相关的题目：[位运算](https://leetcode-cn.com/tag/bit-manipulation/)
### 0.基本概念
| 符号 | 描述 | 运算规则                                                     |
| ---- | ---- | ------------------------------------------------------------ |
| &    | 与   | 两个位都为1时，结果才为1                                     |
...
## 八、区间合并
### 1.步骤
+ 1) 按照区间左端点排序：为什么这么做，实际涉及到贪心，参考[LeetCode 56.合并区间](https://leetcode-cn.com/problems/merge-intervals/)的[一篇题解](https://leetcode-cn.com/problems/merge-intervals/solution/he-bing-qu-jian-by-leetcode-solution/)
+ 2) 如图所示，可分3种情况进行处理
